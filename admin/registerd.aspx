<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="registerd.aspx.cs" Inherits="admin_registerd" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="1010px" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnRowDeleting="GridView1_RowDeleting">
        <Columns>
            <asp:BoundField  HeaderText="USER ID" DataField="id"/>
                ...
                <asp:BoundField  HeaderText="USER ADDRESS" DataField="address"/>   
